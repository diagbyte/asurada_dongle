...
> 실제로 소비하는 [**diagbyte/zmk-config-asurada**](https://github.com/diagbyte/zmk-config-asurada)를
> 참고하세요.
...
> trackball — lives in
> [**diagbyte/zmk-config-asurada**](https://github.com/diagbyte/zmk-config-asurada),
> a real config that consumes this module.
